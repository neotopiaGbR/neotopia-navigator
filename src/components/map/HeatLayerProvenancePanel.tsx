 ...
 * 
 * Shows information about active heat layers:
...
import type { AggregationMethod } from './ecostress/compositeUtils';
        ...
        <>
          ...
          {ecostressLoading ? (
            ...
            <LayerInfo
              ...
              aggregation={aggregationMethod === 'max' ? 'Maximum' : '90. Perzentil'}
              status="active"
              statusText="Aktiv"
